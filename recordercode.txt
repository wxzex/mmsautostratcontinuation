...
if getgenv().GoldenPerks[1] then
    ...
    if gperksl ~= "" then
        getgenv().Generated = getgenv().Generated.."--"..RecVersion.."\n"..gperksl..'local '..getgenv().APIVar..' = loadstring(game:HttpGet("https://raw.githubusercontent.com/wxzex/mmsautostratcontinuation/main/autostratscode.txt", true))() \n'..getgenv().APIVar..':Loadout("'..getgenv().Towers[1]..'", "'..getgenv().Towers[2]..'", "'..getgenv().Towers[3]..'", "'..getgenv().Towers[4]..'", "'..getgenv().Towers[5]..'") \n'..getgenv().APIVar..':Map("'..game:GetService("ReplicatedStorage").State.Map.Value..'", true, "'..game:GetService("ReplicatedStorage").State.Mode.Value..'")\n';
    else
        getgenv().Generated = getgenv().Generated .. "--"..RecVersion.."\n"..'local '..getgenv().APIVar..' = loadstring(game:HttpGet("https://raw.githubusercontent.com/wxzex/mmsautostratcontinuation/main/autostratscode.txt", true))() \n'..getgenv().APIVar..':Loadout("'..getgenv().Towers[1]..'", "'..getgenv().Towers[2]..'", "'..getgenv().Towers[3]..'", "'..getgenv().Towers[4]..'", "'..getgenv().Towers[5]..'") \n'..getgenv().APIVar..':Map("'..game:GetService("ReplicatedStorage").State.Map.Value..'", true, "'..game:GetService("ReplicatedStorage").State.Mode.Value..'")\n';
    end
...
local function passArgs(args, Msi, Wave, TM, TS, HalftTime, wasDid)
    if args[1] == "Troops" then
        ...
        elseif args[2] == "Option" and args[3] == "Set" then
            local Troop = args[4]
            local Index = Troop.Troop.Name
            local name = Troop.Name
            local value = Troop.Value
            getgenv().Generated = getgenv().Generated .. getgenv().APIVar..":Option("..Index..", "..Wave..", \""..name.."\", \""..value.."\", "..TM..", "..TS.."."..Msi..", "..tostring(HalftTime or "false")..")\n";
            getgenv().recstatus = "Changed Option Of "..Troop.Troop.Name
            if getgenv().LoggerWindow then
                getgenv().outputRec("Changed Option Of "..Troop.Troop.Name.." ("..getTroopType(Troop.Troop)..")")
            end
            sendw("Changed Option of "..Troop.Troop.Name.." ("..getTroopType(Troop.Troop)..")")
        end
